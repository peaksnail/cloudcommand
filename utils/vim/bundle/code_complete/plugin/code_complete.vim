...
let g:template['c']['for'] = "for (".g:rs."...".g:re."; ".g:rs."...".g:re."; ".g:rs."...".g:re.")\<cr>{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['main'] = "int main(int argc, char \*argv\[\])\<cr>{\<cr>".g:rs."...".g:re."\<CR>return 0;"."\<cr>}"
...
let g:template['cpp']['std']="using  namespace  std;"

" ---------------------------------------------
" bash templates
let g:template['sh'] = {}
let g:template['sh']['bash']="#!/bin/bash"
